...
void display(GLFWwindow* window, double currentTime) {
	...
	//-----------------------  pyramid == 2nd planet
	mvStack.push(mvStack.top());
	mvStack.top() *= glm::translate(glm::mat4(1.0f), glm::vec3(sin((float)currentTime)*8.0, 0.0f, cos((float)currentTime)*8.0)); // planet position
	mvStack.top() *= glm::rotate(glm::mat4(1.0f), (float)currentTime*3, glm::vec3(0.0, 1.0, 0.0)); // planet rotation
	...
	mvStack.pop(); mvStack.pop(); mvStack.pop(); // remove 2nd planet position, sun position, and view matrices from stack
}
