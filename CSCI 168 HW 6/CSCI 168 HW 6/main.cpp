...
void init(GLFWwindow* window) {
	// renderingProgram = Utils::createShaderProgram("GouraudVertShader.glsl", "GouraudFragShader.glsl"); // Q1
	renderingProgram = Utils::createShaderProgram("BlinnPhongVertShader.glsl", "BlinnPhongFragShader.glsl"); // Q2
...
void display(GLFWwindow* window, double currentTime) {
	...
	// get the uniform variables for the MV and projection and normal matrices
	...
	// Q1: setting the light position to follow the mouse curser
	double xpos, ypos;
...
int main(void) {
	...
	GLFWwindow* window = glfwCreateWindow(800, 800, "HW6", NULL, NULL);
