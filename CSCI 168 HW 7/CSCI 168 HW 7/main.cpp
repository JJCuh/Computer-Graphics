...
void installLights(int renderingProgram1, glm::mat4 vMatrix) {
...
void init(GLFWwindow* window) {
	...
	renderingProgram2 = Utils::createShaderProgram("./vert2Shader.glsl", "./frag2Shader1.glsl"); //switch between 1 and 2
...
void display(GLFWwindow* window, double currentTime) {
	...
	currentLightPos = glm::vec3(xpos, ypos, 1.1f);
...
void passTwo(double currentTime) {
	...
	mvStack.push(vMat); // adding to stack
